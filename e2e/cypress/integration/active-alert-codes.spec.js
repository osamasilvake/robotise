context('Active alert codes', () => {
  it('Navigates with menu bar', () => {
    ...
    cy.get('[data-testing-id=NAV_ITEM_ACTIVE_ALERT_CODES]').should(
      'not.be.visible'
    );
  ...
  it('CRUD operations work for new alert code', () => {
     ...
     * CREATE
     */
    cy.get('[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_SYSTEM]').type(
      'cypress-system'
    );

    cy.get('[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_CREATE]').should(
      'be.disabled'
    );

    cy.get('[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_NODE]').type(
      'cypress-node'
    );
    ...
    cy.get(
      '[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_STATUS_ACTIVE]'
    ).click();
    ...
    cy.get(
      '[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_LEVEL_WARNING]'
    ).click();
    ...
    cy.get(
      '[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_DESTINATION_robot-twin]'
    ).click();
    ...
    cy.get('[data-testing-id=ACTIVE_ALERT_CODES_EDITABLE_NOTES]').type(
      'Cypress note...'
    );
    ...
    cy.get('[data-testing-id=ACTIVE_ALERT_CODE_PAGE]').and(
      'contain',
      'Cypress note...'
    );
    ...
    cy.get('[data-testing-id^=ACTIVE_ALERT_CODES_TABLE_ROW_]')
      .last()
      .click();
