context('Passive alert rules', () => {
	it('Navigates with menu bar', () => {
		...
		cy.get('[data-testing-id=NAV_ITEM_PASSIVE_ALERT_RULES]').should('not.be.visible');
	...
	it('CRUD operations work for new alert rule', () => {
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CREATE]').should('be.disabled');
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_KEY]')
			...
			.type('{backspace}')
			.should('not.contain', 'Please use only English characters and "." symbol.')
			.type('cypress.Key');
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_STATUS_NONE]').click();
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_STATUS_ACTIVE]').click();
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_LEVEL_WARNING]').click();
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_DESTINATION_robot-twin]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CREATE]').should('be.disabled');

		cy.get('[data-testing-id^=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_ROW_]').should(
			'have.length',
			1
		);

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_DELETE_0]').should(
			'be.disabled'
		);

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_ADD]').click();
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_FIELD_0]').type('a');

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_0]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_E_0]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_TYPE_0]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_TYPE_NUMBER_0]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_VALUE_0]').type('b');
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_TYPE_STRING_0]').click();
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_CONDITION_NE_0]').click();

		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_EDITABLE_NOTES]').type('Cypress note...');
		...
		cy.get('[data-testing-id=PASSIVE_ALERT_RULES_TABLE_ROW_cypresscode]').click();
