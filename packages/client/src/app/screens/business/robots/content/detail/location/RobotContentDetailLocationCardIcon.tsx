...
import { RobotContentDetailLocationCardIconInterface } from './RobotContentDetailLocation.interface';
import { RobotContentDetailLocationStyles } from './RobotContentDetailLocation.style';

const RobotContentDetailLocationCardIcon: FC<RobotContentDetailLocationCardIconInterface> = (
	props
) => {
...
export default RobotContentDetailLocationCardIcon;
