...
import {
	GeneralAllElevatorCallsSiteComboBoxInterface,
...
const GeneralAllElevatorCallsSite: FC<GeneralAllElevatorCallsSiteInterface> = (props) => {
	...
	const [sitesList, setSitesList] = useState<GeneralAllElevatorCallsSiteComboBoxInterface[]>([]);
	...
	const handleSite = (
		...
		option: GeneralAllElevatorCallsSiteComboBoxInterface | null
	) => {
