...
import {
	...
	GeneralEmailsTableHeadInterface
} from './GeneralEmailsTable.interface';

const GeneralEmailsTableHead: FC<GeneralEmailsTableHeadInterface> = (props) => {
	...
	const handleSortRequest =
		(property: GeneralEmailsTableColumnsTypeEnum) => (event: MouseEvent) => {
...
export default GeneralEmailsTableHead;
