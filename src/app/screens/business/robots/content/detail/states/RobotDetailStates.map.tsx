		...
		case 'batteryState.current':
			return (
				batteryState && {
					...
					date: dateFormat2(batteryState.updatedAt),
					icon: 'flash_auto'
				}
			);
		...
		case 'dockingState.isDocked':
			return (
				dockingState && {
					...
					date: dateFormat2(dockingState.updatedAt),
					icon: 'dock'
				}
			);
		case 'joystickState.isConnected':
			return (
				joystickState && {
					...
					date: dateFormat2(joystickState.updatedAt),
					icon: 'games'
				}
			);
		case 'activity.latest':
			return (
				activityState && {
					...
					date: dateFormat2(activityState.updatedAt),
					icon: 'timer'
				}
			);
		default:
