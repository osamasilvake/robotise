...
export const CreateOrderValidation = (
	...
	if (touched.location) {
		...
		if (!values.location) {
			errors.location =
				'ROBOTS:CONTENT.ORDERS.LIST.OPTIONS.ORDER_NEW.FIELDS.LOCATION.VALIDATIONS.REQUIRED';
		}

		// validate
		if (values.location && Number(values.location) < 0) {
			errors.location =
				'ROBOTS:CONTENT.ORDERS.LIST.OPTIONS.ORDER_NEW.FIELDS.LOCATION.VALIDATIONS.INVALID';
		}
	}
