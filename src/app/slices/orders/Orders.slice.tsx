...
import { RobotOrdersFetchListPayloadInterface } from '../../screens/business/robots/content/orders/RobotOrders.interface';
...
export const OrdersFetchList =
	(payload: RobotOrdersFetchListPayloadInterface, refresh = false) =>
